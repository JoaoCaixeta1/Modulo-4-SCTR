...
public class Modulo1b_Simulador
{
    ...
    /// A porta UDP para a qual os pacotes de dados serão enviados.
    private const int PORTA_ENVIO = 54321;

    /// O intervalo em milissegundos entre o envio de cada pacote.
    /// Simula a taxa de amostragem contínua de um dispositivo real.
    ...
    public static void Main(string[] args)
    {
        ...
        // O 'using' garante que ele será fechado corretamente ao sair do programa.
        using (var udpClient = new UdpClient())
        {
            // Habilita o modo broadcast, permitindo que o pacote seja enviado para
            // todos os dispositivos na rede local, em vez de um destino específico.
            udpClient.EnableBroadcast = true;
            
            // Define o endereço de destino como o endereço de broadcast (255.255.255.255)
            ...
            while (true)
            {
                ...
                // A cada iteração, escolhe um ID aleatório entre 10, 11 e 12.
                // Isso simula um ambiente com 3 IEDs diferentes, tornando o campo
                // 'EventosPorIed' no relatório do Módulo 4 relevante e demonstrável.
                int dispositivoIdAleatorio = 10 + random.Next(3);

                // --- Geração de Dados de Telemetria Realistas ---
                ...
                // Simula temperatura (°C) de um equipamento, variando entre 85°C e 95°C.
                double tempBase = 85.0;
                double tempVariacao = random.NextDouble() * 10;
                double tempFinal = tempBase + tempVariacao;

                // --- Montagem do Pacote de Dados (JSON) ---
                // Cria um objeto anônimo que representa a estrutura do nosso pacote de dados.
                // Os nomes das propriedades (IedId, Ia, etc.) devem corresponder exatamente
                // ao que o Módulo 4 espera ler.
                var pacoteDados = new
                {
